...
const Intro = () => {
  return (
    <div className="flex items-center justify-center flex-col text-center md:text-start pt-20 pb-6">
        ...
        <h3 className="text-sm md:text-xl mb-6 font-normal">Software Engineer Intern</h3> 
        <a className="text-sm md:text-lg mb-6 font-normal hover:font-semibold" href="/assets/xiaokunli.pdf" download>Download Resume <DownloadForOfflineIcon sx={{ fontSize:{xs:25, md:30}, "&:hover": { color: "gray" } }}/></a>
